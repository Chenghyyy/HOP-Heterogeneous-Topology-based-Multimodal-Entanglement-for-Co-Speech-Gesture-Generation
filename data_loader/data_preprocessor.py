...
class DataPreprocessor:
    def __init__(self, clip_lmdb_dir, out_lmdb_dir, n_poses, subdivision_stride,
        ...
        with self.src_lmdb_env.begin() as txn:
            ...
            print('video',self.n_videos)#1369

        self.spectrogram_sample_length = data_utils.calc_spectrogram_length_from_motion_length(self.n_poses, self.skeleton_resampling_fps)
    ...
    def _sample_from_clip(self, vid, clip):
        ...
        # skeleton resampling
        clip_skeleton = data_utils.resample_pose_seq(clip_skeleton, clip_e_t - clip_s_t, self.skeleton_resampling_fps)
